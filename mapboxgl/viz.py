...
class CircleViz(object):
    ...
    def __init__(self, data, column, access_token, div_id='map', width='100%', height='500px'):
        ...
        if not access_token.startswith('pk'):
            raise ValueError('Mapbox access token must be public (pk)')
